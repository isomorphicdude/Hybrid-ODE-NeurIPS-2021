...
def ravel_pytree(possibly_sequence: Union[Sequence, torch.Tensor]) -> Tuple[torch.Tensor, Callable]:
    ...
    def unravel(flat: torch.Tensor):
        """
        Takes a flat tensor and splits it into chunks of 
        sizes corresponding to the original tensors. 
        Each chunk is then reshaped back to its 
        original shape using the corresponding "unravel" function.
        """
